...
export async function getBookmarkPostsByPagenation(
  userId: number,
  pageNumber: number,
  chunkSize: number,
...
export async function recordCommentVote(
  postId: number,
  commentId: number,
  voteType: 'like' | 'dislike',
  voteUserIpHash: string,
...
export async function judgeIsBookmarked(
  postId: number,
...
export async function updatePostWithTagsAndHistory({
  postId,
  postTitle,
  postContentHtml,
  tags,
