...
export default function PostCard({
    ...
    return (
        <div className="bg-base-100 p-4 grid grid-cols-[1fr_minmax(auto,_800px)_1fr]">
            ...
            <div className="mx-2">
                ...
                <NavLink to={`/archives/${postId}`} className="hover:underline hover:underline-offset-4">
                    <img src={`https://healthy-person-emulator-public-assets.s3.ap-northeast-1.amazonaws.com/${postId}.jpg`} alt={postTitle} className="w-full object-cover"/>
