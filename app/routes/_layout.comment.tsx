...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const commentFeedData = await getFeedComments(
    Number(pagingNumber),
      ...
      <div className="my-2">
        ...
        >
          <option
            ...
            selected={commentFeedData.meta.type === 'timeDesc'}
          >
            新着順
          </option>
          <option
            value="timeAsc"
            className="select-option"
            selected={commentFeedData.meta.type === 'timeAsc'}
          >
            古い順
          </option>
          <option
            value="likes"
            className="select-option"
            selected={commentFeedData.meta.type === 'likes'}
          >
            いいね順
          </option>
          <option
            ...
            className="select-option"
            selected={commentFeedData.meta.type === 'unboundedLikes'}
          >
            無期限いいね順
          </option>
        </select>
