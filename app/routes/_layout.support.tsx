...
export default function BeSponsor() {
  return (
    <div className="text-center">
      ...
      <p>
        暗黙知を共有できる場所を作るためには、サーバー代をはじめとしたある程度の金銭が必要です。現在、健常者エミュレータ事例集の運営には以下のコストがかかっています。
      </p>
      <br />
      ...
      <br />
      <p>
        もし健常者エミュレータ事例集の理念に共感していただけるのなら、以下のPixiv
        Fanboxから寄付していただけると助かります。
      </p>
      <a
        href="https://contradiction29.fanbox.cc/"
        className="btn-primary font-bold py-2 px-8 rounded-md block w-full mt-8"
      >
        サポートする
      </a>
