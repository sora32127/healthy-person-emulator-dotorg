...
export const fctPostEditHistory = sqliteTable(
  ...
  (table) => [primaryKey({ columns: [table.postId, table.postRevisionNumber] })],
);

// ============================================================
// 9. fct_aicompletion_suggestion_history
// ============================================================
export const fctAicompletionSuggestionHistory = sqliteTable('fct_aicompletion_suggestion_history', {
...
// ============================================================
export const fctAicompletionCommitHistory = sqliteTable('fct_aicompletion_commit_history', {
...
// ============================================================
export const fctUserBookmarkActivity = sqliteTable('fct_user_bookmark_activity', {
