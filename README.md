...
3. デザイン上の問題やバグを報告する、コードの改善を提案する
   - 本リポジトリでは、リポジトリオーナー（@sora32127）以外からのPull RequestおよびIssueは受け付けておりません
   - デザイン上の問題やバグを発見した場合、または機能追加・コード改善の提案がある場合は、[Discord](https://discord.com/invite/sQehNGTnSg)の #エンジニアリング議論 チャンネル、もしくは管理人の[X DM](https://x.com/messages/compose?recipient_id=1249916069344473088)までご連絡ください
   - 提案の検討・実装は管理人が責任を持って行います
4. 経済的に支援する
